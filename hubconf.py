...
def custom(path='best.pt', autoshape=True, verbose=True, device=None, pretrained=True):
    # YOLOv5 custom or local model
    return _create(path, pretrained, autoshape=autoshape, verbose=verbose, device=device)
